...
final menuItemsProvider = Provider<List<MenuItem>>(
  (ref) => const [
    ...
    MenuItem(
      ...
      modifierGroups: [
        ModifierGroup(name: 'Size', multiSelect: false, options: [
          ModifierOption(id: 'b_reg', name: 'Regular', price: 5500),
          ModifierOption(id: 'b_lg', name: 'Large', price: 7500),
        ]),
        ModifierGroup(name: 'Extras', multiSelect: true, options: [
          ModifierOption(id: 'cheese', name: 'Extra Cheese', price: 500),
          ModifierOption(id: 'bacon', name: 'Bacon', price: 1000),
          ModifierOption(id: 'jalapeno', name: 'Jalapeños', price: 250),
          ModifierOption(id: 'sauce', name: 'Extra Sauce', price: 250),
        ]),
      ],
    ),
    MenuItem(
      ...
      modifierGroups: [
        ModifierGroup(name: 'Size', multiSelect: false, options: [
          ModifierOption(id: 'b_reg', name: 'Regular', price: 6500),
          ModifierOption(id: 'b_lg', name: 'Large', price: 8500),
        ]),
        ModifierGroup(name: 'Extras', multiSelect: true, options: [
          ModifierOption(id: 'cheese', name: 'Extra Cheese', price: 500),
          ModifierOption(id: 'bacon', name: 'Bacon', price: 1000),
    ...
    MenuItem(
      ...
      modifierGroups: [
        ModifierGroup(name: 'Size', multiSelect: false, options: [
          ModifierOption(id: 'p_sm', name: 'Small', price: 8000),
          ModifierOption(id: 'p_md', name: 'Medium', price: 10000),
          ModifierOption(id: 'p_lg', name: 'Large', price: 13000),
        ]),
        ModifierGroup(name: 'Toppings', multiSelect: true, options: [
          ModifierOption(id: 'xtra_cheese', name: 'Extra Cheese', price: 500),
          ModifierOption(id: 'mushrooms', name: 'Mushrooms', price: 500),
          ModifierOption(id: 'olives', name: 'Olives', price: 500),
          ModifierOption(id: 'peppers', name: 'Peppers', price: 500),
        ]),
      ],
    ),
    MenuItem(
      ...
      modifierGroups: [
        ModifierGroup(name: 'Size', multiSelect: false, options: [
          ModifierOption(id: 'p_sm', name: 'Small', price: 10000),
          ModifierOption(id: 'p_md', name: 'Medium', price: 12000),
          ModifierOption(id: 'p_lg', name: 'Large', price: 15000),
        ]),
        ModifierGroup(name: 'Toppings', multiSelect: true, options: [
          ModifierOption(id: 'xtra_cheese', name: 'Extra Cheese', price: 500),
          ModifierOption(id: 'mushrooms', name: 'Mushrooms', price: 500),
